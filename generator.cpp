...
QSet<Datum*> Generator::randomSet(unsigned int size, QRect bounds, QVector<Class*> classes)
{
    QSet<Datum*> set;
...
QSet<Datum*> Generator::spiral(QRect bounds, double baseRadius, double radiusIncreaseFactor, double startingAngle, double noiseMargin, Class * dataClass)
{
...
QSet<Datum*> Generator::doubleSpiral(QRect bounds, double baseRadius, double radiusIncreaseFactor, double startingAngle, double noiseMargin, Class * class1, Class * class2)
{
    QSet<Datum*> set1 = spiral(bounds, baseRadius, radiusIncreaseFactor, startingAngle, noiseMargin, class1);
    QSet<Datum*> set2 = spiral(bounds, baseRadius, radiusIncreaseFactor, startingAngle + 180, noiseMargin, class2);
    return set1 + set2;
}
